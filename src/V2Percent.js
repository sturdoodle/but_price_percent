      ...
      <div className="Appk">
        <div className="container-xxl bd-gutter">
          ...
          <div className="form-group row mt-5">
            <label htmlFor="initialPrice " className="lead col-sm-2 col-form-label">Initial Price</label>
          ...
          <div className="form-group mt-2 row" >
            <label htmlFor="percent" className="lead col-sm-2 col-form-label">Percentage1</label>
            <div className="col-sm-10">
          ...
          <div className="form-group row mt-2">
            <label htmlFor="initialPrice " className="lead col-sm-2 col-form-label">Price1</label>
            <div className="col-sm-10">{finalPrice}
            </div>
          </div>
          
          <div className="form-group mt-2 row" >
            <label htmlFor="percent" className="lead col-sm-2 col-form-label">Percentage2</label>
            <div className="col-sm-10">
          ...
          {/* <div className="form-group row mt-2">
            <label htmlFor="initialPrice " className="lead col-sm-2 col-form-label">Final Price</label>
            <div className="col-sm-10">{finalPrice2}
            </div>
          </div> */}
